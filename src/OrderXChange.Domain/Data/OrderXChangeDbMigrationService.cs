...
public class OrderXChangeDbMigrationService : ITransientDependency
{
    public ILogger<OrderXChangeDbMigrationService> Logger { get; set; }
    ...
    public OrderXChangeDbMigrationService(
        ...
        IEnumerable<IOrderXChangeDbSchemaMigrator> dbSchemaMigrators)
    {
        ...
        Logger = NullLogger<OrderXChangeDbMigrationService>.Instance;
    }
