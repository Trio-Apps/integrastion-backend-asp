...
public class OrderXChangeDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public OrderXChangeDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
