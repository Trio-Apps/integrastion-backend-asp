...
namespace OrderXChange.Migrations
{
    ...
    [Migration("20260825070547_AddUserBranches")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderXChange.Authorization.RoleBranch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("RoleId")
                        .HasDatabaseName("IX_RoleBranches_RoleId");

                    b.HasIndex("TenantId", "RoleId", "FoodicsAccountId", "FoodicsBranchId")
                        .IsUnique()
                        .HasDatabaseName("IX_RoleBranches_Tenant_Role_Account_Branch");

                    b.ToTable("AppRoleBranches", (string)null);
                });

            modelBuilder.Entity("OrderXChange.Authorization.UserBranch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_UserBranches_UserId");

                    b.HasIndex("TenantId", "UserId", "FoodicsAccountId", "FoodicsBranchId")
                        .IsUnique()
            ...
            modelBuilder.Entity("OrderXChange.Availability.ItemAvailabilityState", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.Property<DateTime?>("RestoreAtUtc")
                        .HasColumnType("datetime(6)");
                    ...
                    b.HasIndex("TenantId", "FoodicsAccountId", "EntityType", "FoodicsProductId", "VendorCode")
                        .IsUnique()
                        .HasDatabaseName("IX_ItemAvailability_Tenant_Account_Product_Vendor");

                    b.ToTable("AppItemAvailabilityStates", (string)null);
                });
            ...
            modelBuilder.Entity("OrderXChange.Domain.Staging.TalabatOrderSyncLog", b =>
                {
                    ...
                    b.HasIndex("TenantId", "IsDeleted", "ReceivedAt")
                        .HasDatabaseName("IX_TalabatOrderSyncLogs_Tenant_Deleted_ReceivedAt");

                    b.HasIndex("TenantId", "IsDeleted", "VendorCode", "Status", "ReceivedAt")
            ...
            modelBuilder.Entity("Volo.Abp.TenantManagement.Smtp.SmtpConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Volo.Abp.TenantManagement.Talabat.TalabatAccount", b =>
                {
                    ...
                    b.Property<string>("DefaultFoodicsCustomerAddressId")
                        .HasColumnType("longtext");

                    b.Property<string>("DefaultFoodicsCustomerAddressName")
                        .HasColumnType("longtext");

                    b.Property<string>("DefaultFoodicsCustomerId")
                        .HasColumnType("longtext");

                    b.Property<string>("DefaultFoodicsCustomerName")
                        .HasColumnType("longtext");
