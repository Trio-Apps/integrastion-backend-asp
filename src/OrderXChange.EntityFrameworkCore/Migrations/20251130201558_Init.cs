...
namespace OrderXChange.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "FoodicsAccounts",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    OAuthClientId = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OAuthClientSecret = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodicsAccounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FoodicsAccounts_AbpTenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AbpTenants",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DescriptionLocalized = table.Column<string>(type: "TEXT", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    CategoryId = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CategoryName = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TaxGroupId = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TaxGroupName = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TaxRate = table.Column<decimal>(type: "DECIMAL(5,2)", nullable: true),
                    Price = table.Column<decimal>(type: "DECIMAL(18,2)", nullable: true),
                    ProductDetailsJson = table.Column<string>(type: "LONGTEXT", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    GroupsJson = table.Column<string>(type: "TEXT", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PriceTagsJson = table.Column<string>(type: "TEXT", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    DiscountsJson = table.Column<string>(type: "TEXT", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TimedEventsJson = table.Column<string>(type: "TEXT", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppFoodicsProductStaging", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppFoodicsProductStaging_FoodicsAccounts_FoodicsAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodicsProductStaging_BranchId",
                table: "AppFoodicsProductStaging",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodicsProductStaging_CategoryId",
                table: "AppFoodicsProductStaging",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodicsProductStaging_FoodicsAccountId",
                table: "AppFoodicsProductStaging",
                column: "FoodicsAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodicsProductStaging_FoodicsProductId",
                table: "AppFoodicsProductStaging",
                column: "FoodicsProductId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodicsProductStaging_IsActive",
                table: "AppFoodicsProductStaging",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_FoodicsProductStaging_SyncDate",
                table: "AppFoodicsProductStaging",
                column: "SyncDate");

            migrationBuilder.CreateIndex(
                name: "IX_FoodicsProductStaging_TenantId",
                table: "AppFoodicsProductStaging",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodicsAccounts_TenantId",
