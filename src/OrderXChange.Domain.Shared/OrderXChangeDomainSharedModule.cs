...
public class OrderXChangeDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        OrderXChangeGlobalFeatureConfigurator.Configure();
        OrderXChangeModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<OrderXChangeDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<OrderXChangeResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/OrderXChange");

            options.DefaultResourceType = typeof(OrderXChangeResource);
        ...
        {
            options.MapCodeNamespace("OrderXChange", typeof(OrderXChangeResource));
        });
    }
}
