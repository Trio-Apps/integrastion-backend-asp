...
```
127.0.0.1 orderxchange-local-web
127.0.0.1 orderxchange-local-webgateway
127.0.0.1 orderxchange-local-authserver
```
...
Now, you can browse the URL: `https://orderxchange-local-web`
